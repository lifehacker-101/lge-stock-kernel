...
/*LGE CHANGE
 *sometimes 23us of delay is not sufficient enough
 *for the current ongoing data trasferring to stop.
 *QCT sugguested to increase below delay time value to 10ms
 *for SDCC version 4(ex. 8974) which works with AHB bus master.
 */
#define CORE_AHB_DATA_DELAY_US 10000
#else
